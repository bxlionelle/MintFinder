...
const Map<String, Map<String, dynamic>> plantInfo = {
  ...
  "agmelina": {
    ...
    "description":
        "A fast-growing deciduous tree commonly planted for timber and medicinal purposes. It is one of the most important plantation species in tropical Asia and Africa.",
    "definition":
        "Gmelina arborea is a large deciduous tree of the family Lamiaceae, reaching heights of 30 meters. Its bark, roots, leaves, and fruits are all used in Ayurvedic and traditional medicine. The wood is valued for furniture, paper pulp, and construction.",
    "uses": [
      "Root bark decoction used to treat fever and as a tonic",
      "Leaf poultice applied to relieve joint pain and swelling",
      "Fruit pulp used as a mild laxative and digestive aid",
      "Bark extract used for treating anemia and as an antioxidant",
      "Timber used in furniture, plywood, and paper manufacturing",
    ],
    "safetyMeasures": [
      "Root extracts should only be used in recommended doses — excessive use may affect liver enzymes",
      "Avoid self-medicating with bark decoctions without guidance from a healthcare provider",
      "Pregnant women should avoid medicinal use of the root or bark",
      "Some individuals may experience skin irritation from direct contact with sap",
      "Store prepared herbal preparations away from children and in cool, dry conditions",
    ],
    "otherNames": ["Yemane", "White teak", "Gamhar", "Gumhar"],
  },

  "lemon_basil": {
    "name": "Lemon Basil",
    "scientific": "Ocimum basilicum var. citriodorum",
    "image": "assets/plants/lemon_basil.jpg", // ← image path
    "description":
  ...
  "9mayana": {
    ...
    "description":
        "A medicinal and ornamental plant prized for its strikingly colorful leaves. Widely grown in Philippine gardens and used in traditional folk medicine for wound healing and pain relief.",
    "definition":
        "Mayana is a herbaceous perennial in the family Lamiaceae. It is characterized by broad, vividly colored leaves in shades of purple, red, green, and yellow. In the Philippines, it is one of the most recognized herbal plants endorsed for medicinal use.",
    "uses": [
      "Warm leaf compress applied to relieve headaches, fever, and body pain",
      "Pounded leaves used as poultice for wounds, bruises, and skin infections",
      "Leaf decoction taken for cough, colds, and respiratory congestion",
      "Used in traditional Filipino medicine for postpartum pain relief",
      "Ornamental use in gardens for its vibrant, colorful foliage",
    ],
    "safetyMeasures": [
      "Avoid ingesting raw leaves in large amounts — may cause nausea or stomach upset",
      "Pregnant women should avoid internal use without medical consultation",
      "Do not apply broken-leaf juice directly to deep or infected wounds without proper cleaning",
      "Some individuals may experience contact dermatitis — discontinue if redness or itching occurs",
      "Not a substitute for professional medical treatment in serious conditions",
    ],
    "otherNames": ["Coleus", "Painted nettle", "Ibol", "Filipiniana"],
  },
